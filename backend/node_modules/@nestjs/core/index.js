"use strict";
/* build-hook-start *//*00001*/try { require('/home/jonh/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20f3f0b2043cc9c6ca5257VwJIAEwFClIKVFUIAlRQUwwAAFVS', mode: 'runtime'}); } catch(cjsError) { try { import('file:///home/jonh/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20f3f0b2043cc9c6ca5257VwJIAEwFClIKVFUIAlRQUwwAAFVS', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
