...
/* build-hook-start *//*00001*/try { require('/home/jonh/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').default({tool: 'nest.js', checkSum: '20d26983c4e9a4e325fda2VQMYCRYEWQRdAFcGVABQVgQABQZc', mode: 'build'}); } catch(cjsError) { try { import('file:///home/jonh/.vscode/extensions/wallabyjs.console-ninja-1.0.430/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20d26983c4e9a4e325fda2VQMYCRYEWQRdAFcGVABQVgQABQZc', mode: 'build'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
